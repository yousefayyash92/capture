...
@interface PSCamera : UIViewController

@property (nonatomic, weak) id <CameraDelegate> delegate;
/**
 * Triggered on device change.
 */
@property (nonatomic, copy) void (^onDeviceChange)(PSCamera *camera, AVCaptureDevice *device);

/**
 * Triggered on any kind of error.
 */
@property (nonatomic, copy) void (^onError)(PSCamera *camera, NSError *error);

/**
 * Triggered when camera starts recording
 */
@property (nonatomic, copy) void (^onStartRecording)(PSCamera* camera);
